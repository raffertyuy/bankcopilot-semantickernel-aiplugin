This is the starter README for the C# ChatGPT plugin deployed on Azure Functions, used by [/src/bank-transactions-azfunction-csharp](./src/bank-transactions-azfunction-csharp/).
