...
namespace NativeFunctions.MathSkill;
...
public class Multiply
{
    ...
    [OpenApiOperation(operationId: "Multiply", tags: new[] { "MathSkill" }, Description = "Multiply two numbers. When increasing by a percentage, don't forget to add 1 to the percentage.")]
